...
var originalTitle;
var blinkOrder = 0;
var audioogg = new Audio(siteurl+'plugins/ichat/app/includes/audio/chat.ogg');
var audiomp3 = new Audio(siteurl+'plugins/ichat/app/includes/audio/chat.mp3');
...
emojione.imagePathPNG = siteurl+'plugins/ichat/app/plugins/smiley/assets/png/';
emojione.imagePathSVG = siteurl+'plugins/ichat/app/plugins/smiley/assets/svg/';
...
function msg_eventpl(chatboxtitle,sender,img,message_content,time,position){
    ...
    var ichat_eventpl = '<li class="clearfix m-t-10 conversers2">' +
    ...
    if(position == "append"){
        $("#chatbox_"+chatboxtitle+" .chatboxcontent").append(ichat_eventpl);
        $("#chatbox_"+chatboxtitle+" .chatboxcontent").scrollTop($("#chatbox_"+chatboxtitle+" .chatboxcontent")[0].scrollHeight);
    }
    else{
        $("#chatbox_"+chatboxtitle+" .chatboxcontent").prepend(ichat_eventpl);
    }
...
function msg_oddtpl(chatboxtitle,sender,img,message_content,time,position,icon){
    ...
    //var tooltip = '<div class=\'tooltiptext\'><img class=\'pull-left\' src=\'storage/profile/'+img+'\'> '+sender+' <i>'+time+'</i></div>';
    var ichat_oddtpl = '<li class="clearfix m-t-10 odd conversers1">' +
    ...
    if(position == "append"){
        $("#chatbox_"+chatboxtitle+" .chatboxcontent").append(ichat_oddtpl);
        $("#chatbox_"+chatboxtitle+" .chatboxcontent").scrollTop($("#chatbox_"+chatboxtitle+" .chatboxcontent")[0].scrollHeight);
    }
    else{
        $("#chatbox_"+chatboxtitle+" .chatboxcontent").prepend(ichat_oddtpl);
    }
}
...
function createChatBox(chatboxtitle,chatheaderimg,status,minimizeIChatBox) {
    ...
    $("<div />" ).attr("id","chatbox_"+chatboxtitle)
        ...
        '<footer class="iichat-footer iichat-chat-footer chatboxinput"> ' +
        '<div id="chatFrom"> ' +
        ...
        '</div> ' +
        '</div> ' +
        '<div class="iichat-box-items-positioning-container"><div class="iichat-box-items-overlay-container"><div class="target-emoji" style="display: none"><div id="include-smiley-panel"></div></div></div></div>'+
        '</footer> ' +
        '</div> ' +
        '</div>' +
        '</div>')
