...
<section id="main" class="clearfix user-page">
    <div class="container">
        <div class="row text-center">
            <!-- user-login -->
            <div class="col-sm-12 col-sm-offset-2 col-md-6 col-md-offset-3">
                <div class="user-account">
                    ...
                    <div class="social-signup socialLoginDivHide" style="padding-bottom: 20px;">
                        <div class="row">
                            IF("{FACEBOOK_APP_ID}"!=""){
                            <div class="col-xs-3"><!--<a class="loginBtn loginBtn--facebook" onclick="fblogin()"><i class="fa fa-facebook"></i> <span>Facebook</span></a> --></div>
                            {:IF} 
                            IF("{GOOGLE_APP_ID}"!=""){
                          <center>  <div class="col-xs-12"><a class="loginBtn loginBtn--google" onclick="gmlogin()"><i class="fab fa-google"></i> <span style="padding:10px;">Google login</span></a></div></center>
                            {:IF}
                        </div>
                        <div class="clear"></div>
                    </div>
