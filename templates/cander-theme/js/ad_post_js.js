...
function post_advertise(){
    ...
    $('#post-advertise-form').ajaxSubmit(function(data) {
        ...
        if(data.status == "error"){
            ...
            $('#post_ad_email_exist #markad_email_already_linked').html(data.errors);
            $('#post_ad_email_exist #markad_username_display').html(data.username);
            $('#post_ad_email_exist #markad_email_display').html(data.email);
...
$(document).ready(function() {
    ...
    $('.markad-template .modal .close').on('click', function () {
        $('#post_ad_email_exist').removeClass('show').addClass('hide');
...
$('#sub_category').on('click', 'li', function (e) {
    ...
    if(photoshow == 1){
        $('#markad-photo-field').show();
    }else{
        $('#markad-photo-field').hide();
    }
    if(priceshow == 1){
        $('#markad-price-field').show();
    }else{
        $('#markad-price-field').hide();
    }
