...
<section class="bg-white py-8">
    ...
    <div class="container">
        ...
        <div class="section-title text-center mb-8 position-relative">
            ...
            <p class="font-weight-bold text-gray-600 markad_lang_translator" data-markad-lang="{LANG_ALL_PACKAGES}">{LANG_ALL_PACKAGES}</p>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $.each($('.markad_lang_translator'), function() {
            $lang = $(this).data('markad-lang');
            $(this).html($lang);
        });
