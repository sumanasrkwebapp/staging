                            ...
                            {/LOOP: SUBCATEGORY}
                                ...
                                <input type="button" name="next" class="next btn btn-info" value="Next" />
                                    ...
                                    <li>
                                            ...
                                            <ol>
                                                <li class="form-step">
                                                    <select id="postadcity" name="city" class="large-input focusable-field" style="width:300px;">
                                  ...
                                  name="comments"></textarea>
                                    ...
                                    <li>
                                        <div class="PagePostProject-submit">
                                            ...
                                            <button id="submit_advertise" class="btn btn-primary" type="button" name="Submit"><span>{LANG_POST_Y_AD}</span></button>
