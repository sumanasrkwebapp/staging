...
<head>
  ...
  <style type="text/css">
  #post-advertise-form fieldset:not(:first-of-type) {
    display: none;
  }
...
<!-- Link to existing markad account -->
            ...
            <div class="modal-body" id="fb-modal-body">
                <div class="FacebookSignUpModal-content">
                    ...
                    <form class="FacebookSignUpModal-form fl-form" style="display:block">
                        <div class="form-step">
                            <p>
                                <span id="markad_email_already_linked"></span>
                                <br>
                        ...
                        <div class="form-step">
                            ...
                            <div id="markad_username_display"></div>
                        </div>
                        <div class="form-step">
                            <label>{LANG_EMAIL}:</label>
                            <div id="markad_email_display"></div>
                        </div>
                        <div class="form-step">
                            <input type="hidden">
            ...
            <ul class="tg-subcategories" style="display: none">
               ...
               <div class="form-group selected-product" id="change-category-btn" style='display: none'>
                                ...
                                <li style="padding-bottom: 20px;">
                                    ...
                                    <div class="row form-group" id="markad-price-field">
                               ...
                               <!--     <fieldset class='PagePostProject-fieldset IF("{POST_ADDRESS_MODE}"!="1"){ hidden {:IF}'> -->
                                ...
                                <li>
                                    <div class="PagePostProject-submit">
                                        ...
                                        <button id="submit_advertise" class="btn  btn-info " type="submit" name="Submit"><span>{LANG_POST_Y_AD}</span></button>
