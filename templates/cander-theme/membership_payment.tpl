                    ...
                    <div class="payment">
                        ...
                        IF("{PAYMENT_TYPES.folder}"=="flutterwave"){
                            ...
                            <div class="payment-tab">
                                <div class="payment-tab-trigger">
                                    <input name="payment_method_id" class="payment_method_id" id="{PAYMENT_TYPES.folder}" type="radio" value="{PAYMENT_TYPES.id}" data-name="flutterwave">
                                    <label for="{PAYMENT_TYPES.folder}">{PAYMENT_TYPES.title}</label>
                                    <img class="payment-logo {PAYMENT_TYPES.folder}" src="{SITE_URL}storage/payments/{PAYMENT_TYPES.folder}/logo.png" alt="">
                                </div>

                                <div class="payment-tab-content">
                                    <p>{LANG_REDIRECT_FLUTTERWAVE}</p>
                                </div>
                            </div>
                            <!-- Flutterwave -->
                        {:IF}
                        ...
                        IF("{PAYMENT_TYPES.folder}"=="razorpay"){
                            ...
                            <div class="payment-tab">
                                <div class="payment-tab-trigger">
                                    <input name="payment_method_id" class="payment_method_id" id="{PAYMENT_TYPES.folder}" type="radio" value="{PAYMENT_TYPES.id}" data-name="razorpay">
                                    <label for="{PAYMENT_TYPES.folder}">{PAYMENT_TYPES.title}</label>
                                    <img class="payment-logo {PAYMENT_TYPES.folder}" src="{SITE_URL}storage/payments/{PAYMENT_TYPES.folder}/logo.png" alt="">
                                </div>

                                <div class="payment-tab-content">
                                    <p>{LANG_REDIRECT_RAZORPAY}</p>
                                </div>
                            </div>
                            <!-- Razorpay -->
                        {:IF}
...
<!-- Flutterwave Payment Method Check -->
<script>
    ...
    $(document).ready(function ()
    {
        ...
        $('#subscribeNow').on('click', function (e)
        {
            ...
            if (paymentMethod != 'flutterwave' || packagePrice <= 0) {
                return false;
            }
            $('#subscribeForm').submit();
...
<script>
    ...
    $(document).ready(function ()
    {
        ...
        $('#subscribeNow').on('click', function (e)
        {
            ...
            if (paymentMethod != 'razorpay' || packagePrice <= 0) {
                return false;
            }
            $('#subscribeForm').submit();
