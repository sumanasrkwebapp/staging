...
if (isset($_SESSION['markad'][$access_token]['payment_type'])) {
    ...
    $fname =$_SESSION['markad'][$access_token]['firstname'];
    $lname = $_SESSION['markad'][$access_token]['lastname'];
    $fullname = $fname." ".$lname;
    $address = $_SESSION['markad'][$access_token]['BillingAddress'];
    $city = $_SESSION['markad'][$access_token]['BillingCity'];
    $state = $_SESSION['markad'][$access_token]['BillingState'];
    $zipcode = $_SESSION['markad'][$access_token]['BillingZipcode'];
    $country = $_SESSION['markad'][$access_token]['BillingCountry'];
