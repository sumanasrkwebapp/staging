...
<style>
    ...
    .markad-template .default-table tbody {
        border: none;
        border-bottom: 1px solid #DEDEDE;
    }
    .markad-template .default-table.table-alt-row tr:nth-child(even) {
        background-color: #F0F0F0;
    }
    .markad-template .default-table tbody tr {
    ...
    .markad-template .default-table tbody tr:hover {
        -webkit-transition: all .2s ease-out;
        transition: all .2s ease-out;
        background-color: #dbf4ff!important;
        border: 1px solid #75d5ff!important;
    }
    .markad-template .default-table tbody td {
        vertical-align: top;
    }
    .markad-template .default-table td, .markad-template .default-table th {
        padding: 13px;
    }
