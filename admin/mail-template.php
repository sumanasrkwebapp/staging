...
?>
<style>
    #markad-tbs .note-toolbar.panel-heading {
        padding: 0 10px 5px;
    }
</style>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a class="btn btn-sm btn-warning" href="setting.php#markad_email">Email Configuration Setting</a>
                </div>
            </div>
                                                ...
                                                <div class="panel panel-default markad-main">
                                                    <div class="panel-body">
                                                        <h4 class="markad-block-head">
                                                            <span class="markad-category-title">Email Template</span>
                                                        </h4>
                                                        <div class="markad-margin-top-xlg">
                                                            <div class="panel-group">
                                                                <!--0.Create Account Details Email-->
                                                                <div class="panel panel-default markad-js-collapse">
                                                                            ...
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="markad-flexbox">
                                                                                    <div class="markad-flex-cell markad-vertical-middle" style="width: 1%">
                                                                                        <i class="markad-js-handle markad-icon markad-icon-draghandle markad-margin-right-sm markad-cursor-move ui-sortable-handle" title="Reorder" style="display: none;"></i>
                                                                                    </div>
                                                                                    <div class="markad-flex-cell markad-vertical-middle">
                                                                                        <a role="button" class="panel-title markad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_0" aria-expanded="false" aria-controls="service_1">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="markad-flexbox">
                                                                                    ...
                                                                                    <div class="markad-flex-cell markad-vertical-middle">
                                                                                        <a role="button" class="panel-title markad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_1" aria-expanded="false" aria-controls="service_1">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="markad-flexbox">
                                                                                    ...
                                                                                    <div class="markad-flex-cell markad-vertical-middle">
                                                                                        <a role="button" class="panel-title markad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_2" aria-expanded="false" aria-controls="service_2">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="markad-flexbox">
                                                                                    ...
                                                                                    <div class="markad-flex-cell markad-vertical-middle">
                                                                                        <a role="button" class="panel-title markad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_3" aria-expanded="false" aria-controls="service_3">
                                                                                            Contact Us Email </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="markad-flexbox">
                                                                                    ...
                                                                                    <div class="markad-flex-cell markad-vertical-middle">
                                                                                        <a role="button" class="panel-title markad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_4" aria-expanded="false" aria-controls="service_4">
                                                                                            Feedback Email </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="markad-flexbox">
                                                                                    ...
                                                                                    <div class="markad-flex-cell markad-vertical-middle">
                                                                                        <a role="button" class="panel-title markad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_5" aria-expanded="false" aria-controls="service_5">
                                                                                            Report Email </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="markad-flexbox">
                                                                                    ...
                                                                                    <div class="markad-flex-cell markad-vertical-middle">
                                                                                        <a role="button" class="panel-title markad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_6" aria-expanded="false" aria-controls="service_6">
                                                                                            Ad Approve Email </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="markad-flexbox">
                                                                                    ...
                                                                                    <div class="markad-flex-cell markad-vertical-middle">
                                                                                        <a role="button" class="panel-title markad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_7" aria-expanded="false" aria-controls="service_7">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="markad-flexbox">
                                                                                    ...
                                                                                    <div class="markad-flex-cell markad-vertical-middle">
                                                                                        <a role="button" class="panel-title markad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_8" aria-expanded="false" aria-controls="service_8">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="markad-flexbox">
                                                                                    ...
                                                                                    <div class="markad-flex-cell markad-vertical-middle">
                                                                                        <a role="button" class="panel-title markad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_9" aria-expanded="false" aria-controls="service_9">
        ...
        <div class="modal-content">
            <form id="test_notification_send" action="ajax_sidepanel.php?action=testEmailTemplate" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div id="markad-tbs">
                        <div class="btn-group markad-margin-bottom-lg markad-services-holder">
                            <button class="btn btn-default btn-block dropdown-toggle markad-flexbox" data-toggle="dropdown">
                                <div class="markad-flex-cell text-left" style="width: 100%">Notification templates (10)</div>
                                <div class="markad-flex-cell">
                                    <div class="markad-margin-left-md"><span class="caret"></span></div>
                                </div>
                            </button>
                            <ul class="dropdown-menu" style="width: 570px">
                                <li class="markad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="markad-check-all-entities" value="any" id="all-template">
                                ...
                                <li class="markad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success" href="#">
                                        <input type="checkbox" class="markad-js-check-entity" value="any" id="signup-details" name="signup-details">
                                        <label for="signup-details">Signup account details email </label>
                                    </a>
                                </li>
                                <li class="markad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="markad-js-check-entity" value="any" id="create-account" name="create-account">
                                        <label for="create-account">Create account confirmation email </label>
                                    </a>
                                </li>
                                <li class="markad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="markad-js-check-entity" value="any" id="forgot-pass" name="forgot-pass">
                                        <label for="forgot-pass">Forgot Password Email </label>
                                    </a>
                                </li>
                                <li class="markad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="markad-js-check-entity" value="any" id="contact_us" name="contact_us">
                                        <label for="contact_us">	Contact Us Email</label>
                                    </a>
                                </li>
                                <li class="markad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="markad-js-check-entity" value="any" id="feedback" name="feedback">
                                        <label for="feedback">	Feedback Email</label>
                                    </a>
                                </li>
                                <li class="markad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="markad-js-check-entity" value="any" id="report" name="report">
                                        <label for="report"> Report Email</label>
                                    </a>
                                </li>
                                <li class="markad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="markad-js-check-entity" value="any" id="ad_approve" name="ad_approve">
                                        <label for="ad_approve"> Ad Approve Email</label>
                                    </a>
                                </li>
                                <li class="markad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="markad-js-check-entity" value="any" id="re_ad_approve" name="re_ad_approve">
                                        <label for="re_ad_approve">	Re-submit Ad Approve Email</label>
                                    </a>
                                </li>
                                <li class="markad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="markad-js-check-entity" value="any" id="contact_to_seller" name="contact_to_seller">
                                        <label for="contact_to_seller">	Contact to seller Email</label>
                                    </a>
                                </li>
                                <li class="markad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="markad-js-check-entity" value="any" id="ad_newsletter" name="ad_newsletter">
...
<script>
    ...
    $(document).on('change', '.markad-check-all-entities', function () {
        $(this).parents('.markad-services-holder').find('.markad-js-check-entity').prop('checked', $(this).prop('checked'));
    });
