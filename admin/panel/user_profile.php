...
<div class="app-contacts">
    <header class="slidePanel-header" style="background-image: url(assets/images/user-bg.jpg)">
    ...
    <div class="slidePanel-actions">
        <div class="btn-group-flat">
            <button type="button" class="btn btn-pure btn-inverse slidePanel-close icon ion-android-close font-size-20" aria-hidden="true" data-dismiss="modal"></button>
        </div>
    </div>
