        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="white-box">
                    ...
                    <form name="form2" style="margin-top: 2%" class="form form-horizontal" method="post" data-ajax-action="addCity" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            if($statecode == ""){
                                ?>
                                <div class="row">
                                    <label class="col-sm-4 col-form-label">Region (Admin1 Code)</label>
                                    <div class="col-sm-6">
                            ...
                            if($districtcode == ""){
                                ?>
                                <div class="row">
                                    <label class="col-sm-4 col-form-label">District (Admin2 Code)</label>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                            ...
                            <!-- text input -->
                            <div class="row">
                                <label class="col-sm-4 col-form-label">Time Zone ID</label>
                                <div class="col-sm-6">
                                    <div class="form-group">
