...
var App = function() {
	...
	var uiHelperTableToolsCheckable = function() {
        ...
        $(document).on("click", "[data-toggle=slidePanel]", function (e) {
            ...
            $('#userModal .modal-content').html('<div class="preloader" style=""><div class="cssload-speeding-wheel"></div></div>');
            $('#userModal').modal({show:true});
            $('#userModal .modal-content').load($(this).data("url"),function(){
	...
	return {
		...
		initDatatable: function(tableElem){
			var $jsonfile = tableElem.data('jsonfile');
			if($jsonfile != undefined){
				tableElem.DataTable({
					"bProcessing": true,
					"serverSide": true,
