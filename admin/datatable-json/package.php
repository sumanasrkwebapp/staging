...
foreach ($queryRecords as $row) {
    ...
    if($removable == '1'){
        $removable = '<span class="badge badge-info">YES</span>';
    }
    else{
        $removable = '<span class="badge badge-warning">NO</span>';
    }
    $row0 = '<td>
    ...
    $row4 = '<td class="text-center">
                <div class="btn-group">
                    <a href="#" data-url="panel/package_edit.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-sm btn-info"> <i class="ion-edit"></i> Edit</a>
                </div>
            </td>';
