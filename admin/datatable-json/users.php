...
foreach ($queryRecords as $row) {
    ...
    elseif($status == "1")
    {
        ...
        $status = '<span class="badge badge-warning">BANNED</span>';
    }
    ...
    $row6 = '<td class="text-center">
                <div class="btn-group">
                    <a href="#" data-url="panel/user_profile.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-sm btn-primary user-view"> <i class="ion-eye"></i></a>
                    <a href="#" data-url="panel/users_edit.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-sm btn-success user-edit"> <i class="ion-edit"></i></a>
                    <a href="javacript:void(0)" class="btn btn-sm btn-danger item-js-delete" data-target="#userModal" data-ajax-action="deleteusers"><i class="ion-close"></i></a>
                </div>
            </td>';
    $value = array(
        "DT_RowId" => $id,
