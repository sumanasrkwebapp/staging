...
foreach ($queryRecords as $row) {
    ...
    $active = $row['active'];
    if ($active == "0")
        $active = '<span class="badge badge-warning">Not Active</span>';
    else
    ...
    $row4 = '<td class="text-center">
                <div class="btn-group">
                    <a href="#" data-url="panel/page_edit.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-sm btn-primary"> <i class="ion-edit"></i> Edit</a>
                    <a href="javacript:void(0)" class="btn btn-sm btn-danger item-js-delete" data-ajax-action="deleteStaticPage"> <i class="ion-close"></i></a>
                </div>
            </td>';
