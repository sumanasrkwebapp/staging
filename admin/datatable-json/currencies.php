...
foreach ($queryRecords as $row) {
    ...
    $row5 = '<td class="text-center">
                <div class="btn-group">
                    <a href="#" data-url="panel/currency_edit.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-sm btn-primary"> <i class="ion-edit"></i> Edit</a>
                    <a href="javacript:void(0)" class="btn btn-sm btn-danger item-js-delete" data-ajax-action="deleteCurrency"> <i class="ion-close"></i></a>
                </div>
            </td>';
