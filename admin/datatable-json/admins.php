...
foreach ($queryRecords as $row) {
    ...
    $row3 = '<td class="text-center">
                <div class="btn-group">
                    <a href="#" data-url="panel/admin_edit.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-sm btn-info"> <i class="ion-edit"></i> Edit</a>
                    <a href="javacript:void(0)" class="btn btn-sm btn-danger item-js-delete" data-ajax-action="deleteadmin"><i class="ion-close"></i></a>
                </div>
            </td>';
    $value = array(
        "DT_RowId" => $id,
