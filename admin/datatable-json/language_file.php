...
foreach ($queryRecords as $row) {
    ...
    $row1 = '<td>'.$code.'</td>';
    $row2 = '<td>'.$name.'<a href="language_file.php?file='.$file_name.'" class="btn btn-xs btn-primary font-12"> <i class="ion-edit"></i> Edit '.$file_name.' file</a></td>';
    $row3 = '<td>'.$direction.'</td>';
    $row4 = '<td>'.$active.'</td>';
    $row5 = '<td class="text-center">
                <div class="btn-group">
                    <a href="#" data-url="panel/language_edit.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-sm btn-default"> <i class="ion-edit"></i> Edit</a>
