...
foreach ($queryRecords as $row) {
    ...
    $row6 = '<td class="text-center">
                <div class="btn-group">
                    <a href="#" data-url="panel/timezone_edit.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-sm btn-primary"> <i class="ion-edit"></i> Edit</a>
                    <a href="javacript:void(0)" class="btn btn-sm btn-danger item-js-delete" data-ajax-action="deleteTimezone"> <i class="ion-close"></i></a>
                </div>
            </td>';
