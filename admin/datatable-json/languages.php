...
foreach ($queryRecords as $row) {
    ...
    if ($active == "1"){
        ...
        $active = '<span class="badge badge-warning">Deactivate</span>';
    }
    ...
    $row1 = '<td>'.$code.'</td>';
    $row2 = '<td>'.$name.'&nbsp;<a href="language_file.php?file='.$file_name.'" class="btn btn-sm btn-primary font-12"> <i class="ion-edit"></i> Edit '.$file_name.' file</a></td>';
    $row3 = '<td>'.$direction.'</td>';
    $row4 = '<td>'.$active.'</td>';
    $row5 = '<td class="text-center">
                <div class="btn-group">
                    <a href="#" data-url="panel/language_edit.php?id='.$id.'" data-toggle="slidePanel" class="btn btn-sm btn-primary"> <i class="ion-edit"></i> Edit</a>
                    <a href="#" class="btn btn-sm btn-danger item-js-delete" data-ajax-action="deleteLanguage"> <i class="ion-close"></i></a>
                </div>
            </td>';
