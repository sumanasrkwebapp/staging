...
if(checkloggedin())
{
    if(isset($_POST['upgrade']))
    {
        ...
        {            
            $access_token = uniqid();
            $_SESSION['markad'][$access_token]['name'] = $title." ".$lang['MEMBERSHIPPLAN'];
            $_SESSION['markad'][$access_token]['amount'] = $amount;
            $_SESSION['markad'][$access_token]['payment_type'] = $payment_type;
            $_SESSION['markad'][$access_token]['sub_id'] = $_POST['upgrade'];
            $_SESSION['markad'][$access_token]['payment_mode'] = $pay_mode;

            if($term == 'DAILY')
            {
                $_SESSION['markad'][$access_token]['plan_interval'] = "day";
            }
            elseif($term == 'WEEKLY')
            {
                $_SESSION['markad'][$access_token]['plan_interval'] = "week";
            }
            elseif($term == 'MONTHLY')
            {
                $_SESSION['markad'][$access_token]['plan_interval'] = "month";
            }
            elseif($term == 'YEARLY')
            {
                $_SESSION['markad'][$access_token]['plan_interval'] = "year";
            }
            ...
            if($folder == "2checkout"){
                $_SESSION['markad'][$access_token]['firstname'] = $_POST['checkoutCardFirstName'];
                $_SESSION['markad'][$access_token]['lastname'] = $_POST['checkoutCardLastName'];
                $_SESSION['markad'][$access_token]['BillingAddress'] = $_POST['checkoutBillingAddress'];
                $_SESSION['markad'][$access_token]['BillingCity'] = $_POST['checkoutBillingCity'];
                $_SESSION['markad'][$access_token]['BillingState'] = $_POST['checkoutBillingState'];
                $_SESSION['markad'][$access_token]['BillingZipcode'] = $_POST['checkoutBillingZipcode'];
                $_SESSION['markad'][$access_token]['BillingCountry'] = $_POST['checkoutBillingCountry'];
            }

            $_SESSION['markad'][$access_token]['folder'] = $folder;
