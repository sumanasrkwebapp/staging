...
if(isset($_GET['i']) && isset($_GET['access_token']))
{
    ...
    if(isset($_SESSION['markad'][$access_token])){
...
if(isset($_POST['payment_method_id']))
{
    ...
    $_SESSION['markad'][$access_token]['payment_mode'] = "one-time";
    ...
    if (isset($_SESSION['markad'][$access_token]['payment_type'])) {
        $_SESSION['markad'][$access_token]['name'];
        $_SESSION['markad'][$access_token]['payment_type'];
        $payment_types = array();
        ...
        $product_id = $_SESSION['markad'][$access_token]['product_id'];
