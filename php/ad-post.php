        ...
        if (!count($errors) > 0) {
            ...
            if (checkloggedin()) {
                ...
                if ($amount > 0) {
                    ...
                    $_SESSION['markad'][$access_token]['name'] = $title;
                    $_SESSION['markad'][$access_token]['amount'] = $amount;
                    $_SESSION['markad'][$access_token]['payment_type'] = $payment_type;
                    $_SESSION['markad'][$access_token]['trans_desc'] = $trans_desc;
                    $_SESSION['markad'][$access_token]['product_id'] = $product_id;
                    $_SESSION['markad'][$access_token]['featured'] = $featured;
                    $_SESSION['markad'][$access_token]['urgent'] = $urgent;
                    $_SESSION['markad'][$access_token]['highlight'] = $highlight;
